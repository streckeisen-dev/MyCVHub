...
#resume(
  ...
  [
      ...
      heading(getTitle(profile.language, "Über Mich", "About Me"))
      profile.bio
    }

    #if (profile.at("workExperiences", default: none) != none and profile.workExperiences.len() > 0) {
      heading(getTitle(profile.language, "Berufserfahrung", "Work Experience"))
      ...
      heading(getTitle(profile.language, "Ausbildung", "Education"))
      ...
      heading(getTitle(profile.language, "Projekte", "Projects"))
      ...
      block(breakable: false, {
        heading(getTitle(profile.language, "Fähigkeiten", "Skills"))
